      ...
      <div className="relative w-full h-screen">
        <BackgroundBeams className="w-full h-full">
          <div className="flex flex-col items-center justify-center text-center p-4 space-y-8 z-10">
            ...
            <h2 className="text-xl md:text-2xl text-gray-700 max-w-2xl">
              Web developer, QA, and PHP developer
            </h2>
            <div className="flex gap-4">
              <Link 
                  href="#timeline" 
                  className="px-6 py-3 bg-transparent hover:bg-gray-300 text-gray-800 border border-gray-300 rounded-md transition-all"
                >
                  My Journey
                </Link>
              <Link 
                href="#projects" 
                className="px-6 py-3 bg-primary-500 hover:bg-primary-600 text-black rounded-md transition-all"
              >
                View My Work
              </Link>
              <Link 
            ...
            {certificates.map((cert, index) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-500 text-xs">Completed: {cert.date}</p>
                </div>
              </div>
            ))}
          </div>
